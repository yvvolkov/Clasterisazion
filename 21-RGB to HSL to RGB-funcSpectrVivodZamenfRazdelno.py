...
for y in range(width-0): #y - номер столбца
   for x in range(height-0):  #x - номер строки
       ...
       A2[x][y] = g
       A3[x][y] = b
       M2 = modus.RGBtoHSL(r, g, b) #преобразование прямое  r,g,b => h,l,s
       H = M2[0][0]
       Sp = M2[0][1]
       Lp = M2[0][2]
       ...
       HI, SpI, LpI = modus.HSLFindH(H, Sp, Lp, JarkFon, NasishFon, zvetFon, zvetVibor,zvetNew, Delta)
       #обратное преобразование с одновременной заменой цвета  h,l,s => rOI,gOI,bOI
       M3 = modus.HSLtoRGB(HI, SpI, LpI)
       A7I[x][y] = M3[0][0] #=rOI
       A8I[x][y] = M3[0][1] #=gOI
       A9I[x][y] = M3[0][2] #=bOI
picture1 = modus.RGBNew(picture, A7I, A8I, A9I) #заменяем исходные значения в каналах r,g,b => rOI,gOI,bOI на восстановленные
picture1.show()
picture1.save('Result-76.jpg')
print("")
